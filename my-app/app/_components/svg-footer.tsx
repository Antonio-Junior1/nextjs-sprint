...
export function SvgFooter() {
  return (
    <footer className="bg-black w-full min-h-[350px] py-5 box-border">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center my-12 mx-4 md:mx-[200px] gap-6">
        <div className="flex gap-5">
          ...
          >
            <g clipPath="url(#clip0_2012_82)">
              <path
                d="M40 20.1493C40 9.1036 31.0457 0.149292 20 0.149292C8.9543 0.149292 0 9.1036 0 20.1493C0 31.195 8.9543 40.1493 20 40.1493C31.0457 40.1493 40 31.195 40 20.1493Z"
                fill="white"
                fillOpacity="0.12"
              />
              <mask
                ...
                height="18"
              >
                <path d="M28.75 11.3993H11.25V28.8993H28.75V11.3993Z" fill="white" />
              </mask>
              <g mask="url(#mask0_2012_82)">
                <path
                  d="M21.6649 18.8056L28.1796 11.3993H26.6359L20.9791 17.83L16.461 11.3993H11.25L18.0822 21.1237L11.25 28.8903H12.7939L18.7676 22.0992L23.539 28.8903H28.75L21.6649 18.8056ZM19.5503 21.2094L18.8581 20.2411L13.3502 12.5359H15.7215L20.1664 18.7542L20.8587 19.7226L26.6366 27.8054H24.2653L19.5503 21.2094Z"
                  fill="white"
                />
              </g>
            </g>
            <defs>
              <clipPath id="clip0_2012_82">
                <rect
                  ...
                  height="40"
                  fill="white"
                  transform="translate(0 0.149292)"
                />
              </clipPath>
            </defs>
          </svg>
            ...
            <defs>
              <clipPath id="clip0_2012_97">
                <rect
                  ...
                  height="40"
                  fill="white"
                  transform="translate(0.984375 0.149292)"
                />
              </clipPath>
            </defs>
          </svg>
          ...
          >
            <g clipPath="url(#clip0_2012_89)">
              <path
                d="M40.3281 20.1493C40.3281 9.1036 31.3738 0.149292 20.3281 0.149292C9.28243 0.149292 0.328125 9.1036 0.328125 20.1493C0.328125 31.195 9.28243 40.1493 20.3281 40.1493C31.3738 40.1493 40.3281 31.195 40.3281 20.1493Z"
                fill="white"
                fillOpacity="0.12"
              />
              <path
              ...
              <path
                d="M12.3281 14.6498C13.4327 14.6498 14.3281 13.7544 14.3281 12.6498C14.3281 11.5452 13.4327 10.6498 12.3281 10.6498C11.2235 10.6498 10.3281 11.5452 10.3281 12.6498C10.3281 13.7544 11.2235 14.6498 12.3281 14.6498Z"
                fill="white"
              />
            </g>
            <defs>
              <clipPath id="clip0_2012_89">
                <rect
                  ...
                  height="40"
                  fill="white"
                  transform="translate(0.328125 0.149292)"
                />
              </clipPath>
            </defs>
          </svg>
