    ...
    <div className="w-full min-h-screen">
      ...
      <div className="text-white flex items-center justify-between p-[200px_116px]">
        <section className="text-[50px] font-semibold w-[592px] min-h-[352px] flex flex-col text-start">
          ...
          <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12.0859" cy="12" r="9" stroke="#7eff79" stroke-width="2"/><path d="M8.08594 12L11.0859 15L16.0859 9" stroke="#9fff79" stroke-width="2"/></svg>

            <p className="ml-2">Àgil prático e fácil</p>
          </span>
          <span className="text-sm flex items-center text-black mt-3">
          <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12.0859" cy="12" r="9" stroke="#89ff79" stroke-width="2"/><path d="M8.08594 12L11.0859 15L16.0859 9" stroke="#8fff79" stroke-width="2"/></svg>
      ...
      <div className="flex justify-between items-center my-12 mx-[200px] box-border">
        ...
        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M40.6562 20.1493C40.6562 9.1036 31.7019 0.149292 20.6562 0.149292C9.61055 0.149292 0.65625 9.1036 0.65625 20.1493C0.65625 31.195 9.61055 40.1493 20.6562 40.1493C31.7019 40.1493 40.6562 31.195 40.6562 20.1493Z" fill="white" fill-opacity="0.12"/>
            ...
            <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_2012_89)">
              <path d="M40.3281 20.1493C40.3281 9.1036 31.3738 0.149292 20.3281 0.149292C9.28243 0.149292 0.328125 9.1036 0.328125 20.1493C0.328125 31.195 9.28243 40.1493 20.3281 40.1493C31.3738 40.1493 40.3281 31.195 40.3281 20.1493Z" fill="white" fill-opacity="0.12"/>
